...
import { clickToAddPointsCodeSnippets } from '@/constant/line/clickToAddPoints';
import {
    EChartsOption,
    EChartsReact,
    EChartsReactRef,
...
const ClickToAddPoints = () => {
    ...
    useEffect(() => {
        ...
        if (chartInsatnce) {
            ...
            zr.on('click', function (params) {
                ...
                const pointInGrid = chartInsatnce.convertFromPixel(
                    'grid',
                    pointInPixel
                );
    ...
    return (
        <>
            <Drawer>{clickToAddPointsCodeSnippets}</Drawer>
